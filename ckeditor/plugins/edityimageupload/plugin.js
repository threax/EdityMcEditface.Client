...
(function () {
    CKEDITOR.plugins.add('edityimageupload', {
        ...
        init: function (editor) {
            ...
            if (!uploadUrl) {
                CKEDITOR.error('edityimageupload-config');
                return;
            }

            // Handle images which are available in the dataTransfer.
            fileTools.addUploadWidget(editor, 'edityimageupload', {
                ...
                onUploaded: function (upload) {
                    ...
                    this.replaceWith('<img src="' + upload.url + '" class="fitImage">');
                }
            });
            ...
            editor.on('paste', function (evt) {
                ...
                for (i = 0; i < imgs.count() ; i++) {
                    ...
                    if (isDataInSrc && isRealObject && !img.data('cke-upload-id') && !img.isReadOnly(1)) {
                        ...
                        fileTools.markElement(img, 'edityimageupload', loader.id);
