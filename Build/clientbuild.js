...
function build(outDir, iconOutPath, moduleDir) {
    ...
    //Views
    promises.push(copy.glob(rootDir + '/Views/**/*.css', rootDir + '/Views', outDir + '/edity/layouts'));
    promises.push(copy.glob(rootDir + '/Views/**/*.html', rootDir + '/Views', outDir + '/edity/layouts'));
    //Templates
    promises.push(copy.glob(rootDir + '/Templates/**/*.css', rootDir + '/Templates', outDir + '/edity/Templates'));
    promises.push(copy.glob(rootDir + '/Templates/**/*.html', rootDir + '/Templates', outDir + '/edity/Templates'));
