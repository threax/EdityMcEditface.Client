...
function build(outDir, iconOutPath, moduleDir, filesDir) {
    ...
    //Views
    promises.push(copy.glob(filesDir + '/Views/**/*.css', filesDir + '/Views', outDir + '/edity/layouts'));
    promises.push(copy.glob(filesDir + '/Views/**/*.html', filesDir + '/Views', outDir + '/edity/layouts'));
    promises.push(copy.glob(filesDir + '/Views/**/*.json', filesDir + '/Views', outDir + '/edity/layouts'));
    promises.push(less.compile({
        encoding: 'utf8',
        importPaths: [filesDir, moduleDir + '/bootstrap/less'],
    ...
    promises.push(copy.glob(filesDir + '/Templates/**/*.json', filesDir + '/Templates', outDir + '/edity/Templates'));
    promises.push(less.compile({
        encoding: 'utf8',
        importPaths: [filesDir, moduleDir + '/bootstrap/less'],
