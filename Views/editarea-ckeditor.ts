...
var baseUrlInjector = controller.InjectedControllerBuilder.GlobalScope.getRequiredService(IBaseUrlInjector);
var pageService = controller.InjectedControllerBuilder.GlobalScope.getRequiredService(page.PageService);
...
CKEDITOR.editorConfig = function (config) {
    ...
    config.imageUploadUrl = baseUrlInjector.BaseUrl + '/edity/Page/AddAsset?page=' + window.location.pathname;
};
