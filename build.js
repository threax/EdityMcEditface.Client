...
module.exports = function (outDir, iconOutPath) {

    var promises = [];

    //promises.push(less({
    //    encoding: 'utf8',
    //    importPaths: [__dirname, __dirname + '/../bootstrap/less'],
    //    inFile: __dirname + '/SpcBootstrap.less',
    //    outFile: outDir + "/bootstrap/dist/css/SpcBootstrap.css",
    //    compress: true,
    //}));

    //Copy favicon
    //var faviconPromise = copy.file(
    //    __dirname + '/favicon.ico',
    //    iconOutPath + '/favicon.ico'
    //);

    //File Copy, get the fonts
    //promises.push(copy.dir(
    //    __dirname + "/../bootstrap/dist/fonts",
    //    outDir + "/bootstrap/dist/fonts"
    //));

    //File Copy, images
    //var imagePromise = copy.dir(
    //    __dirname + '/Images',
    //    outDir + '/SpcBootstrap/Images'
    //);
